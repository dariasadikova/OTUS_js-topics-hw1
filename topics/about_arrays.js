...
test("splice", function() {
    ...
    deepEqual(workingWeek, ['Saturday', 'Sunday'], 'what is the value of workingWeek?');
    deepEqual(weekend, ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'], 'what is the value of weekend?');
});
